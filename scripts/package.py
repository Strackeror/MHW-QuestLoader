...
with ZipFile('x64/Loader-Release.zip', 'w') as zip:
    ...
    zip.write("x64/Release/hid.dll", "hid.dll")
...
shutil.copyfile("x64/Release/loader.lib", "Plugins/ExamplePlugin/dependencies/loader.lib")
shutil.copyfile("MHWLoader/loader.h", "Plugins/ExamplePlugin/dependencies/loader.h")
